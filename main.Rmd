...
```
We calculate a SUS-like score for a system where participants needs to calibrate the intensity.
...
This was kind of visible from first plot showing the histogram of the scores and this is also reinforced by seeing the distribution of the scores using box and violin plots
...
## PART 2 Analysis of In-Experiment Measured Data (dynamic range, elapsed time)
...
For the calibration variables, we will focus only in the calibration range.
